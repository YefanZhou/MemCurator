...
Example:
    python convert_checkpoint.py \
        --checkpoint_path "/home/ouyangsiru/ckpt/skillos-grpo-memory-agent-qwen3-4b-no-compression-no-thinking-8node/global_step_40" \
        --output_dir "/home/ouyangsiru/converted_models/skillos-grpo-qwen3-4b-step40-8node" \
...
try:
    ...
    print("Make sure you're running this script from the SkillCurator directory")
    sys.exit(1)
