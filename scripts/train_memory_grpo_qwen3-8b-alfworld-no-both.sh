...
# Ablation: remove both compression and content rewards
...
exp_name="qwen3-8b-8b-skills-alfworld-ablation-no-both+content${function_content_reward_weight}+compression${compression_ratio_weight}"
