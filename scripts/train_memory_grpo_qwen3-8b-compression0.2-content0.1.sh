...
compression_ratio_weight=0.2
function_content_reward_weight=0.1
sub_sample_question_ratio=1.0

# Project and experiment configuration
project_name='SkillOS'
exp_name="qwen3-8b-4node-compression${compression_ratio_weight}-content${function_content_reward_weight}"
...
# Data paths
export DATA_DIR='/home/siruo_google_com/SkillCurator/data'
export ROLLOUT_DATA_DIR="${DATA_DIR}/${exp_name}"
TRAIN_DATA_DIR='/home/siruo_google_com/SkillCurator/data/'
TEST_DATA_DIR='/home/siruo_google_com/SkillCurator/data/'
