...
# export LD_LIBRARY_PATH=/home/siruo_google_com/memory_env/lib:$LD_LIBRARY_PATH
...
exp_name="qwen3-8b-8b-skills-alfworld-signal+content${function_content_reward_weight}+compression${compression_ratio_weight}"
...
# Data paths
export DATA_DIR='/home/siruo_google_com/SkillCurator/data/math'
