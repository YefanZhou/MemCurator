...
# Ablation: remove content reward (function_content_reward_weight=0.0)
...
exp_name="qwen3-8b-8b-skills-alfworld-ablation-no-content+content${function_content_reward_weight}+compression${compression_ratio_weight}"
