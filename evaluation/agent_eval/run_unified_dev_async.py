...
def _apply_curation_output(skill_memory: SkillMemory, raw: str, label: str = "", task: str = None):
    # `task` = the current task description; forwarded to execute_tool so inserted/
    # updated skills record their originating task as the BM25 retrieval key (Option B).
