"""
run_unified_hyper_async_reason_tag.py — rolling-pool async baseline, <reason> prompt.
(Same engine as run_unified_hyper_async.py; only the reasoning tag differs: <reason>.)
