#!/bin/bash
# ==============================================================================
# EXTERNAL API MEMORY sweep — CURATOR_V1 method, executor=API AND curator=API.
...
#
# Usage:
#   bash server_api_curator_v1_gpt_gemini.sh --dry-run
#   tmux new -s api_curv1 'bash .../server_api_curator_v1_gpt_gemini.sh'   # 3 seeds in parallel
