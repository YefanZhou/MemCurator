...
COMMON="EXECUTOR_TOP_P=0.95 EXECUTOR_TOP_K=20 EXECUTOR_MAX_TOKENS=4096 HISTORY_LENGTH=5 \
...
JOBS=()
for i in 1 2 3; do JOBS+=("$PURE|1.0|baseline_pure_async_8b_${TAG}_temp1.0_0.95_20_4096_hist5_run${i}"); done
for i in 1 2 3; do JOBS+=("$RR|1.0|baseline_reviseReact_8b_${TAG}_temp1.0_0.95_20_4096_hist5_run${i}"); done
