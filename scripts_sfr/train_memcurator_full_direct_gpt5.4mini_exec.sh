...
#   bash scripts_sfr/train_memcurator_full_direct_gpt5.4exec.sh
...
exp_name="${EXP_NAME:-memcurator-FULL-gpt5.4mini-exec-alfworld-iter1}"
...
# ---- MemCurator knobs ----
DATASET_PATH="${DATASET_PATH:-/fsx/sfr/yefan.zhou/mem-evolve/data/datasets/full_dataset_gpt5.4_mini_frac0.2_iter1/dataset.jsonl}"
EXECUTOR_MODEL="${EXECUTOR_MODEL:-openai/gpt-5.4-mini}"
